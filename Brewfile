...
brew "http-server"     # Simple HTTP server
brew "awscurl"         # AWS signed HTTP requests
...
brew "ios-deploy"      # iOS app deployment
brew "fastlane"        # Mobile automation

# ============================================
# AI Tools
# ============================================
brew "aicommit2"       # AI commit message generator
